      ...
      <div className="flex justify-between items-center text-sm mb-6">
        ...
        <div className="flex space-x-3">
          <button
            ...
            className={`transition-all duration-300 transform hover:scale-110 ${favoriteLoading
      ...
      <div className="mt-8 bg-white rounded-lg p-6 border border-gray-200">
        ...
        {getCurrentUser() ? (
          <div className="pt-6 border-t">
              ...
              <div className="flex space-x-1">
                {[1, 2, 3, 4, 5].map((star) => (
                  <button
                    ...
                    className={`text-xl transition-colors ${star <= newRating ? "text-yellow-400 hover:text-yellow-500" : "text-gray-300 hover:text-gray-400"
                      }`}
                  >
                    ★
                  </button>
            ...
            <textarea
              className={`w-full p-3 border rounded-lg text-sm focus:ring-1 outline-none transition-all ${validationError
